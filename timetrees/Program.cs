    ...
    class Program
    {
        ...
        static void EditPerson() //сократить, не проверил все остальное
        {
            ...
            {      
                ...
                Console.WriteLine($"Первый родитель: {people[personOneParent].name}\t {people[personOneParent].birth:D}\t {people[personOneParent].death:D}");
                Console.WriteLine($"Второй родитель: {people[personTwoParent].name:D}\t {people[personTwoParent].birth:D}\t {people[personTwoParent].death:D}");
                ConsoleKeyInfo keyInfo = Console.ReadKey(true);
